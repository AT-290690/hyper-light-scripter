...
exports.buildTempApp = async (req, res) => {
  ...
  if (script && isValidHash(portal)) {
    ...
    <div  class="description" style="font-size:10px"><p>by <a href="https://hyper-light-scripter.herokuapp.com/data/storage/root/editor/?script=${script}">Hyper Light Scripter</a></p></div> 
